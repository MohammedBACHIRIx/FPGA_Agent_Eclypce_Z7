...
end entity module_fir_filter;

architecture structural of module_fir_filter is
    signal core_param       :   std_logic_vector(4095 downto 0) := (others => '0'); -- Storing all parameters and control bits for the core module
...
begin
    ...
    parameter_ram : entity work.parameter_ram_4096 generic map(
