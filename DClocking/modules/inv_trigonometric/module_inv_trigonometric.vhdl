...
entity module_inv_trigonometric is
    port(
        clk             :   in  std_logic;
        rst             :   in  std_logic;
...
end entity module_inv_trigonometric;

architecture structural of module_inv_trigonometric is
...
begin
    ...
    core_entity : entity work.inv_trigonometric generic map(
        io_buf => buf_for_io
    )port map(
        clk             =>  clk,
        rst             =>  core_rst,
