...
entity parameter_ram_4096 is
    generic(
        ram_default     :   std_logic_vector(4095 downto 0) := (others => '0')
    );
    port(
        clk             :   in  std_logic;
        rst             :   in  std_logic;
        ...
        ren_in          :   in  std_logic;
        ram_data_out    :   out std_logic_vector(4095 downto 0)
    );
end entity parameter_ram_4096;

architecture behavioral of parameter_ram_4096 is
    constant log_ram_size   : integer := 12;
